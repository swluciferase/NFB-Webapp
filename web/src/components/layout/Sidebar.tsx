...
export type TabType = 'home' | 'impedance' | 'signal' | 'fft' | 'record' | 'training';
...
export const Sidebar: FC<SidebarProps> = ({
  ...
  const tabs: { id: TabType; labelKey: string; icon: ReactNode; requiresConnect: boolean }[] = [
    { id: 'home',      labelKey: 'tabHome',      icon: <ConnectIcon />,   requiresConnect: false },
    ...
    { id: 'training',  labelKey: 'tabTraining',  icon: <TrainingIcon />,  requiresConnect: false },
  ];
